...
## Full onboarding demo (no code verification)

Open **`onboarding-demo.html`** for a Slack-style full flow: email → workspace → notification preference. Looks like the Slack app with purple sidebar. No sign-in required.

## Quick preview

Open **`preview.html`** to see the notification screen only. No Node or npm required.
